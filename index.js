...
function randomWord() {
    ...
    const simpleEnglishWords = [
        ...
        'green', 'hat', 'hello', 'home', 'house', 'ice cream', 'juice', 'kite', 'light', 'love',
...
function match(key) {
    for (let i = 0; i < wordArr.length; i++) {
        if (wordArr[i][0] === key) {
            //to aapa us word na select kar lesa or uske aage check laga sa
            //or sath ma us bubble na select kar kr color bhi change kar sa
